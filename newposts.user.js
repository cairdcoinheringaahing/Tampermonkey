...
(function() {
    ...
    var FORMAT_TIME = (time) => {
         ...
         if (time < MINUTES)
             return "Now";
         if (time < HOURS)
             return (is_one = (time / MINUTES | 0)) + " min" + (is_one == 1 ? "" : "s") + " ago";
         if (time < DAYS)
             return (is_one = (time / HOURS | 0)) + " hour" + (is_one == 1 ? "" : "s") + " ago";

         return (is_one = (time / DAYS | 0)) + " day" + (is_one == 1 ? "" : "s") + " ago";
     };
